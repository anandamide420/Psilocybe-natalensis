...
st.markdown(
    ...
    "herbivore dung, not on wood). The broader interest is comparative: "
...
| **3 · Coding changes (genome-wide)** | Proteome-wide protein-vs-DNA identity scatter, 12,589 genes vs *P. cubensis*, gene-group highlighting + psilocybin-locus stars |
...
st.markdown(
    ...
    "certain **wood-inhabiting** *Psilocybe*. It clusters in two regions with endemic "
    "wood-loving species: **Australia / New Zealand** (*P. subaeruginosa* — the source of a "
    "DNA-confirmed clinical case series from Victoria; Silvester *et al.* 2026) and the "
    "**Pacific Northwest USA** (*P. azurescens*, *P. cyanescens*), where the phenomenon was "
    "first noted (Stamets, 1996) and later shaped Oregon's regulatory exclusion of lignicolous "
    "species. It is consistently associated with wood-growing species and **not** with dung- "
    "or grass-associated ones. Paralysis after magic mushrooms was first described in 1973 for "
